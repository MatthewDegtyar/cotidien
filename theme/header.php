...
<div class="antialiased font-jakarta" id="page">
	<div class="w-full main-content-width h-[164px] flex flex-row items-center">
		<div class="w-full flex flex-row justify-between lg:justify-normal">
			...
			<?php if ( ! is_cart() ) : ?>
				<button id="cart-toggle" class="relative flex cursor-pointer">
					<span>Cart</span>

					<?php if ( function_exists( 'WC' ) && WC()->cart->get_cart_contents_count() > 0 ) : ?>
						<span class="absolute -top-2 -left-2 bg-red-500 text-white text-[10px] leading-none font-medium px-[6px] py-[2px] rounded-full">
	...
	<div id="cart-view" class="cart-view">
		<div class="w-full flex flex-row justify-between items-center mb-4">
			<div></div>
			<span class="font-cormorant font-semibold text-[32px]">Cart (<?php echo WC()->cart->get_cart_contents_count(); ?>)</span>
