	...
	<main id="main ">
		...
		<div>
			...
			<div class="w-full flex flex-col items-center justify-center">
				<p><?php esc_html_e('This page could not be found. It might have been removed or renamed, or it may never have existed.', 'cotidien'); ?>
				</p>
				<a class="h-[40px] w-[150px] text-white bg-black flex items-center mt-8 text-center justify-center"
					href="/">Back To Home</a>
			</div>
			<!--
