    ...
    <div class="main-content-width flex flex-col">
        <div class="flex flex-col md:flex-row relative mt-[55px]">
            <div class="md:w-[50%]">
                ...
                <p class="mt-[40px] text-[#828282]" style="margin-right: 20px;">Hi, I'm Sophia, the girl behind
                    Cotidien. Cotidien first came into consciousness via my old sewing machine during 2020 as a way to
                    pass time between online classes. I fell in love with flipping, crafting, and creating pieces that
                    felt true to my style and vision, where I could really sink into the details of each piece and add
                    easter eggs that only I would know to find. At the time, I couldn’t find clothes I loved on
                    mainstream sources, so I made them myself.</p>
                <!-- <br> -->
                <p class="mt-[40px] text-[#828282]" style="margin-right: 20px;">
                    In 2024, I started posting the process on Instagram. Over time, a little community formed of
                    individuals who bought into the journey of creating something from the ground up.</p>
                <!-- <br> -->
                <p class="mt-[40px] text-[#828282]" style="margin-right: 20px;">
                    In 2025, the sewing journey crystalized into something more tangible through Cotidien. "Cote" (꽃),
                    meaning flower in Korean, and "quotidien," meaning everyday in French, together symbolize our
                    brand's mission: to create beautiful, elevated pieces that seamlessly fit into your everyday
                    wardrobe.
                </p>
            </div>
