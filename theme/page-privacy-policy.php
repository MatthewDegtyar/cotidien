...
<main class="privacy-policy-page main-content-width">
    <h1 class="text-[36px] mb-6 font-cormorant">Privacy Policy</h1>
    ...
    <div class="space-y-12">
        ...
        <div>
            ...
            <ul>
                ...
                <li>Order and payment details (processed securely by third parties)</li>
            </ul>
            ...
            <ul>
                ...
                <li>Location data (based on IP, if enabled)</li>
            </ul>
        ...
        <div>
            ...
            <ul>
                <li>Fulfill and deliver orders</li>
                <li>Respond to inquiries and provide customer support</li>
                <li>Send transactional communications (e.g., order confirmations)</li>
                <li>Provide updates, offers, or newsletters (if you opt in)</li>
        ...
        <div>
            ...
            <ul>
                ...
                <li>Right to opt out of the sale of personal data (we don’t sell)</li>
            ...
            <p>To exercise your rights, contact us at <strong>dossier.hui@gmail.com</strong>.</p>
        </div>
